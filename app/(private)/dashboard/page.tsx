...
export default function Dashboard() {
  return (
    <div className="max-w-md mx-auto h-full flex flex-col gap-4 mobile-viewport p-4">
      <h1 className="text-2xl font-bold">Dashboard</h1>
      <p className="text-gray-600">Dashboard is under construction...</p>
    </div>
  )
}

// Commented out for now - to be implemented later
